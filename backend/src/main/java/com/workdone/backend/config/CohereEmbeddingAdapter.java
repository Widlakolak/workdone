...
public class CohereEmbeddingAdapter implements EmbeddingModel {
    ...
    static class ThreadSleeper implements Sleeper {
        @Override
    ...
    static class CohereRateLimiter {
        ...
        CohereRateLimiter(int maxRequestsPerMinute, Sleeper sleeper) {
