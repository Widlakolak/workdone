...
@Profile("!test")
public class JdbcEmbeddingCacheStore implements EmbeddingCacheStore {
    ...
    public void put(String textHash, float[] vector) {
        String sql = "INSERT INTO embedding_cache (text_hash, vector) VALUES (?, ?::vector) ON CONFLICT (text_hash) DO NOTHING";
        try {
